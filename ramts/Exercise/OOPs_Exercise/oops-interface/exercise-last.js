...
var BUS = /** @class */ (function () {
    ...
    BUS.prototype.getdata = function () {
        console.log("Make: ".concat(mybus.make, "\nModel: ").concat(mybus.model, "\nYear: ").concat(mybus.year));
    };
    return BUS;
}());
var bus = new BUS();
...
//     start() {
//          console.log(`The ${mybus.make} ${mybus.model} (Year: ${mybus.year}) is starting.`);
//     }
// }
//       // Create a Bus object
//       const myBus = new Bus();
