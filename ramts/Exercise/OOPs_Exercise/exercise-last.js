...
var Student = /** @class */ (function () {
    ...
    Student.setCollege = function (college) {
        Student.college = college;
    };
    Student.getCollege = function () {
        console.log(" College is: ".concat(Student.college));
    };
    Student.prototype.setData = function (name, roll, branch) {
        this.name = name;
        this.roll = roll;
        this.branch = branch;
    };
    Student.prototype.getData = function () {
        console.log("Name is: ".concat(this.name, "\n Roll is: ").concat(this.roll, "\n Branch is : ").concat(this.branch));
    };
    return Student;
}());
