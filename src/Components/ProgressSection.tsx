...
import { useState } from "react";
import ProgressCard from "./Isolate-Component/ProgressCard";
...
function ProgressSection() {
    ...
    const headerInfo = {
        title: 'Progress',
        desc: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus necessitatibus quos impedit perspiciatis quidem facere commodi vitae quam, minus aut?',
        link: 'Learn More'
    };

    //  Skills 
    const [skills] = useState([
        { name: 'HTML',       percentage: '50%', color: '' }, 
        { name: 'CSS',        percentage: '70%', color: 'bg-danger' },
        { name: 'Javascript', percentage: '90%', color: '' },
        { name: 'Bootstrap',  percentage: '95%', color: 'bg-success' }
    ]);
    ...
    return (
        <section className="p-5">
            <div className="container-fluid">
                ...
                <div className="row">
                    <div className="col-lg-12 text-center mb-3">
                        <h1 className="text-primary font-weight-bold display-3">{headerInfo.title}</h1>
                        <p className="lead text-secondary">{headerInfo.desc}</p>
                        <a href="#">{headerInfo.link}</a>
                    </div>
                </div>
